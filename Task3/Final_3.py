...
class FaceDetection(object):
    ...
    def faceEyeRecognition(self, size=0.9, scaleFactor=1.08, minNeighbors=6):
        ...
        faces = face_cascade.detectMultiScale(self.BRGtoGray(), scaleFactor, minNeighbors, minSize= (100,100))
        ...
        for (x, y, w, h) in faces:
            ...
            eyes = eye_cascade.detectMultiScale(roi_gray, minSize=(10, 10), minNeighbors=8)
...
classifier = FaceDetection("Gruppenfotos_1.jpg")
